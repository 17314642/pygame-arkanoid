...
SCREEN_RECT_LEFT_LINE = (
    SCREEN_RECT.x, SCREEN_RECT.y, SCREEN_RECT.x, SCREEN_RECT.y + SCREEN_RECT.height
)
...
BRICK_TEXTURES_Y = 298

PURPLE_BRICK_TEXTURE_RECT = pg.rect.Rect(19, BRICK_TEXTURES_Y, BRICK_TEXTURES_WIDTH, BRICK_TEXTURES_HEIGHT)
ORANGE_BRICK_TEXTURE_RECT = pg.rect.Rect(137, BRICK_TEXTURES_Y, BRICK_TEXTURES_WIDTH, BRICK_TEXTURES_HEIGHT)
BLUE_BRICK_TEXTURE_RECT = pg.rect.Rect(267, BRICK_TEXTURES_Y, BRICK_TEXTURES_WIDTH, BRICK_TEXTURES_HEIGHT)
RED_BRICK_TEXTURE_RECT = pg.rect.Rect(400, BRICK_TEXTURES_Y, BRICK_TEXTURES_WIDTH, BRICK_TEXTURES_HEIGHT)
YELLOW_BRICK_TEXTURE_RECT = pg.rect.Rect(526, BRICK_TEXTURES_Y, BRICK_TEXTURES_WIDTH, BRICK_TEXTURES_HEIGHT)
GREEN_BRICK_TEXTURE_RECT = pg.rect.Rect(653, BRICK_TEXTURES_Y, BRICK_TEXTURES_WIDTH, BRICK_TEXTURES_HEIGHT)
